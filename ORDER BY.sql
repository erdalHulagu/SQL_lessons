...
select * from kisiler order adres desc; --tresten siralama yapilacagi zaman DECENDING (DESC) kullanilir
-- kisileri maasini azalana dogru siralayin
select * from kisiler order by maas desc;
-- ismi mine olanlari maas azalimina gore siralayin
select * from kisiler where isim= 'Mine' order by maas desc; 
-- Soismi bulut olanlari maasa gore siralayiniz
